    ...
    <footer className="bg-foreground text-background">
      <ScrollReveal direction="none">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
            ...
            <div className="space-y-4">
              ...
              <nav className="flex flex-col space-y-2">
                <a href="#inicio" className="text-background/60 hover:text-background transition-smooth text-sm">Inicio</a>
                <a href="#servicios" className="text-background/60 hover:text-background transition-smooth text-sm">Servicios</a>
                <a href="#fiestas" className="text-background/60 hover:text-background transition-smooth text-sm">Nuestras Fiestas</a>
                <a href="#contacto" className="text-background/60 hover:text-background transition-smooth text-sm">Contacto</a>
              </nav>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  <MapPin className="h-4 w-4 text-background/40 flex-shrink-0" />
          ...
          {/* Bottom Section */}
          <div className="border-t border-background/10 mt-10 sm:mt-12 pt-6 sm:pt-8">
            <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
              ...
              <div className="flex space-x-6 text-xs text-background/40">
                <a href="#" className="hover:text-background/60 transition-smooth">Términos</a>
                <a href="#" className="hover:text-background/60 transition-smooth">Privacidad</a>
              </div>
            </div>
          </div>
        </div>
